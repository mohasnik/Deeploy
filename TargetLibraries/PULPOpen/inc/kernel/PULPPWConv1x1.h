...
#ifndef __DEEPLOY_BASIC_MATH_PULP_PW_CONV_1X1_HEADER_
#define __DEEPLOY_BASIC_MATH_PULP_PW_CONV_1X1_HEADER_

#include <stdint.h>

/* 1x1 / stride 1 / no-pad convolution parallelised over output channels and
   written channels-first, so the depthwise kernel that consumes it needs no
   layout change in between. */
