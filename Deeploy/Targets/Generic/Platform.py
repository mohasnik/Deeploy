...
from Deeploy.Targets.Generic.Bindings import BasicAddBindings, BasicConcatBindings, BasicConv1DBinding, \
    ...
    BasicSliceBindings, BasicSoftmaxBindings, BasicTransposeBindings, DummyBinding, BasicGAPoolBinding
...
GAPMapper = NodeMapper(GlobalAveragePoolParser(), BasicGAPoolBinding)
...
GenericMapping = {
    ...
    'GlobalAveragePool': GlobalAveragePoolLayer([GAPMapper])
}
